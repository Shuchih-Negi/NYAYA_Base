    ...
    <div style={{ maxWidth: 1360, margin: '0 auto', padding: '0.75rem 1rem 1rem' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ fontWeight: 800, fontSize: 13 }}>NYAYA</div>
          ...
          <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: '#e5e5e5' }}>AES-256 SECURED</div>
          <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 11, color: 'var(--accent)' }}>{timerLabel}</div>
        </div>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '60% 40%', gap: 8, minHeight: 'calc(100vh - 170px)' }}>
